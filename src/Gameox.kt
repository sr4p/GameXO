...
//    if(arrOX[2][1] == 'X' && arrOX[2][2] == 'X' && arrOX[2][3] == 'X'){
//        print("X : Win")
//    }
//    if(arrOX[3][1] == 'X' && arrOX[3][2] == 'X' && arrOX[3][3] == 'X'){
//        print("X : Win")
//    }


//    if(arrOX[1][2] == 'X' && arrOX[2][2] == 'X' && arrOX[3][2] == 'X'){
//        print("X : Win")
//    }
//    if(arrOX[1][3] == 'X' && arrOX[2][3] == 'X' && arrOX[3][3] == 'X'){
//        print("X : Win")
//    }

//    if(arrOX[3][1] == 'X' && arrOX[2][2] == 'X' && arrOX[1][3] == 'X'){
//        print("X : Win")
//    }

//    if(arrOX[2][1] == 'O' && arrOX[2][2] == 'O' && arrOX[2][3] == 'O'){
//        print("O : Win")
//    }
//    if(arrOX[3][1] == 'O' && arrOX[3][2] == 'O' && arrOX[3][3] == 'O'){
//        print("O : Win")
//    }

//    if(arrOX[1][2] == 'O' && arrOX[2][2] == 'O' && arrOX[3][2] == 'O'){
//        print("O : Win")
//    }
//    if(arrOX[1][3] == 'O' && arrOX[2][3] == 'O' && arrOX[3][3] == 'O'){
//        print("O : Win")
//    }

//    if(arrOX[3][1] == 'O' && arrOX[2][2] == 'O' && arrOX[1][3] == 'O'){
//        print("O : Win")
//    }